...
public class QkyGenerator {
    ...
    private static void generateCode(GroupTemplate gt) throws IOException {
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir") + "/ripple-service/src/main/java/" + packagePath + "/dao/" + className + "Dao.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir") + "/ripple-service/src/main/java/" + packagePath + "/service/" + className + "Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir") + "/ripple-service/src/main/java/" + packagePath + "/service/impl/" + className + "ServiceImpl.java";
