...
public class RippleGenerator {
     ...
     * serviceImpl对应包
     */
    private static final String serviceImplPackage = "cn.ripple.service";
    ...
    public static void main(String[] args) throws IOException {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/ripple-server-web/src/main/java/cn/ripple/generator/template";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/ripple-server-entity/src/main/java/cn/ripple/entity/"+className+".java";
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/ripple-server-service/src/main/java/cn/ripple/dao/"+className+"Dao.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir")+"/ripple-server-service/src/main/java/cn/ripple/service/"+className+"Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir")+"/ripple-server-service/src/main/java/cn/ripple/service/"+className+"ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/ripple-server-web/src/main/java/cn/ripple/controller/"+className+"Controller.java";
    ...
    private static void deleteCode(String className) throws IOException{
        String entityFileUrl = System.getProperty("user.dir")+"/ripple-server-domain/src/main/java/cn/ripple/domain/"+className+".java";
        File entityFile = new File(entityFileUrl);
        if(entityFile.exists()){
            entityFile.delete();
        }
        ...
        String serviceImplFileUrl = System.getProperty("user.dir")+"/ripple-server-service/src/main/java/cn/ripple/serviceimpl/"+className+"ServiceImpl.java";
        File serviceImplFile = new File(serviceImplFileUrl);
